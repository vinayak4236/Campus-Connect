<?php
// Database reset script for Campus Connect Portal
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["reset"])) {
    ...
    if ($result === true) {
        $success = true;
        $message = "Database reset and import completed successfully!";
    } else {
...
<head>
    ...
    <title>Reset Campus Connect Database</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container">
        <div class="header">
            <h1>Reset Campus Connect Database</h1>
            <p class="text-muted">This tool will completely reset and rebuild the Campus Connect database</p>
        </div>
        ...
        <?php else: ?>
            <div class="warning">
                <h4>⚠️ Warning</h4>
                <p>This action will <strong>completely erase</strong> the existing Campus Connect database and recreate it with fresh data.</p>
                <p>Any custom data or changes you have made will be lost.</p>
            </div>
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <div class="d-grid">
                    <button type="submit" name="reset" class="btn btn-danger">Reset and Rebuild Database</button>
                </div>
            </form>
